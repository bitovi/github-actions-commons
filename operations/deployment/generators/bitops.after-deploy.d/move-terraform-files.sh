...
rm "${BITOPS_ENVROOT}/generators/terraform.tfvars"
  ...
  cp "${BITOPS_ENVROOT}"/generators/aws_default* "${BITOPS_ENVROOT}"/terraform/aws/rds/.
#fi
  ...
  cp "${BITOPS_ENVROOT}"/generators/aws_default* "${BITOPS_ENVROOT}"/terraform/aws/efs/.
#fi
  ...
  cp "${BITOPS_ENVROOT}"/generators/aws_default_tags* "${BITOPS_ENVROOT}"/terraform/aws/eks/.
#fi
