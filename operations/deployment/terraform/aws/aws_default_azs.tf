...
locals {
  ...
  ec2_zone_mapping =   var.aws_ec2_instance_create ? { "${local.preferred_az}" : { "subnet_id" : "${data.aws_subnet.selected[0].id}", "security_groups" : [module.ec2[0].aws_security_group_ec2_sg_name] } } : ""
