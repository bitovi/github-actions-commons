...
if [ "$BITOPS_TERRAFORM_COMMAND" != "destroy" ]; then
  ...
  sed -i.bak -e 's|<ARN of instance role (not instance profile)>|arn:aws:sts::755521597925:assumed-role/AWSReservedSSO_AdministratorAccess_402f22a297379e03/leo@bitovi.com|' aws-auth-cm.yaml
  ...
  sed -i.bak -e 's|"%IAM_ARN%"|arn:aws:sts::755521597925:assumed-role/AWSReservedSSO_AdministratorAccess_402f22a297379e03/leo@bitovi.com|' eks-connector-clusterrole.yaml
  ...
  sed -i.bak -e 's|"%IAM_ARN%"|arn:aws:sts::755521597925:assumed-role/AWSReservedSSO_AdministratorAccess_402f22a297379e03/leo@bitovi.com|' eks-connector-console-dashboard-full-access-group.yaml
