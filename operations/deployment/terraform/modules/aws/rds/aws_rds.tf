...
resource "aws_db_instance" "default" {
  ...
  skip_final_snapshot              = length(coalesce(var.aws_rds_db_final_snapshot, "")) > 0 ? false : true
  final_snapshot_identifier        = length(coalesce(var.aws_rds_db_final_snapshot, "")) > 0 ? var.aws_rds_db_final_snapshot : null
