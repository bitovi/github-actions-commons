...
data "aws_subnet" "default_selected" {
  count             = var.aws_vpc_create ? 0 : contains(data.aws_availability_zones.all.names, var.aws_vpc_availability_zones != "" ? local.aws_vpc_availability_zones[0] : var.aws_vpc_id != "" ? data.aws_subnet.selected[0].availability_zone : local.aws_ec2_zone_selected) ? 1 : 0
