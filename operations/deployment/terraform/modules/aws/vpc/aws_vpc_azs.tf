...
locals {
  ...
  preferred_az = var.aws_vpc_availability_zones != "" ? var.aws_vpc_availability_zones : local.use_default ? local.aws_ec2_instance_type_offerings[random_integer.az_select[0].result] : data.aws_subnet.selected[0].availability_zone
}
