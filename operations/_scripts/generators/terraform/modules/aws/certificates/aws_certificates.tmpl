...
data "aws_acm_certificate" "issued" {
  count  = var.aws_enable_cert == "true" ? (var.create_root_cert != "true" ? (var.create_sub_cert != "true" ? (local.fqdn_provided ? 1 : 0) : 0) : 0) :0
  domain = var.domain_name
}

# This block will create and validate the root domain and www cert
resource "aws_acm_certificate" "root_domain" {
  count                     = var.aws_enable_cert == "true" ? (var.create_root_cert == "true" ? (var.domain_name != "" ? 1 : 0) : 0) : 0
...
resource "aws_acm_certificate" "sub_domain" {
  count             = var.aws_enable_cert == "true" ? (var.create_sub_cert == "true" ? (var.domain_name != "" ? (var.sub_domain_name != "" ? 1 : 0) : 0) : 0) :0
...
resource "aws_acm_certificate_validation" "sub_domain" {
  count                   = var.aws_enable_cert == "true" ? (var.create_sub_cert == "true" ? (var.domain_name != "" ? 1 : 0) : 0) :0
